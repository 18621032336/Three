define(['jquery'], function(require) {
    ...
    function initCanvas(canvas, params) {
        ...
        function resetStyle(){
            ...
            context.font = Math.round(standard * 0.05) + 'px sans-serif'; // 重新设置字体大小
        }
...
//                    context.closePath();
        ...
        function fillText(text, index){
            var standardScaled = standard * AREA_SCALE,
                ...
                y = index * (standardScaled / 5.3) + standardScaled * 0.1,
                height = (standardScaled / 5.3 + standardScaled * 0.1) * 0.9;
