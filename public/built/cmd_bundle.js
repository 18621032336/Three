...
/* 0 */
/*!*******************************************!*\
  !*** ./public/dist/script/control/cmd.js ***!
  \*******************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _base = __webpack_require__(/*! base */ 1);
	
	var _base2 = _interopRequireDefault(_base);
	
	var _pathCore = __webpack_require__(/*! ../path-core */ 2);
	
	var _pathCore2 = _interopRequireDefault(_pathCore);
	
	var _lessonsChapter = __webpack_require__(/*! ../../lessons/chapter */ 5);
	
	var _lessonsChapter2 = _interopRequireDefault(_lessonsChapter);
	
	var _controlUtil = __webpack_require__(/*! ../control-util */ 6);
	
	var _controlUtil2 = _interopRequireDefault(_controlUtil);
	
	var _jquery = __webpack_require__(/*! jquery */ 3);
	
	var _jquery2 = _interopRequireDefault(_jquery);
	
	var _socketIO = __webpack_require__(/*! socketIO */ 7);
	
	var _socketIO2 = _interopRequireDefault(_socketIO);
	
	_controlUtil2['default'].preventDefaultTouch();
	
	var $canvas = (0, _jquery2['default'])('#myCanvas');
	var manager = (0, _pathCore2['default'])($canvas[0], {
	  drawCallback: drawCallback,
	  step: _lessonsChapter2['default']
	});
	
	// 操作页面事件
	(0, _jquery2['default'])('#left').on('touchstart', function () {
	  if (socket.connected) {
	    manager.setStep(0, 0, -1);
	    socket.emit('cmd', '1,' + manager.getPageNumber() + ',' + manager.getStepNumber());
	  }
	});
	(0, _jquery2['default'])('#right').on('touchstart', function () {
	  if (socket.connected) {
	    manager.setStep(0, 0, 1);
	    socket.emit('cmd', '1,' + manager.getPageNumber() + ',' + manager.getStepNumber());
	  }
	...
	(0, _jquery2['default'])('#clear').on('touchstart', function () {
	  if (socket.connected) {
	    socket.emit('clear', 'YES');
	  }
	});
	
	var socket = (0, _socketIO2['default'])(_base2['default'].SOCKET_HOST);
	socket.on('connect', function () {
	  socket.on('message', function (msg) {// 划线指令
	    // 主控制不接受 划线. 否则重复绘制
	  });
	
	  socket.on('clear', function (claer) {
	    // 清除划线
...
/* 2 */
/*!*****************************************!*\
  !*** ./public/dist/script/path-core.js ***!
  \*****************************************/
/***/ function(module, exports, __webpack_require__) {
	  ...
	  if (!params.disabled) {
	    $canvas.on('touchmove', function (e) {
	      ...
	      if (isDown) {
	        ...
	        replayContent += "|" + [startPoint.x, startPoint.y, toPoint.x, toPoint.y].join(',');
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(function (a, b) {
	  ...
	  var c = [],
	    ...
	    var c, d;return l.cors || Hb && !b.crossDomain ? { send: function send(e, f) {
	        var g,
	    ...
	    n.each({ padding: "inner" + a, content: b, "": "outer" + a }, function (c, d) {
	      ...
	      return this.length;
	    } }), n.fn.andSelf = n.fn.addBack, "function" == "function" && __webpack_require__(/*! !webpack amd options */ 4) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
	    return n;
...
/* 5 */
/*!****************************************!*\
  !*** ./public/dist/lessons/chapter.js ***!
  \****************************************/
/***/ function(module, exports) {

	'use strict';
	
	var step = [['>如何编写高质量的子程序？', '>什么是“子程序”？', '为实现目的而编写的一个可被调用的方法或过程(函数)', '>什么是“高质量的子程序”？', '1.差劲的名字', '2.没有注释文档', '3.没有单一而明确的目的', '4.容错', '5.未引用参数', '6.参数过多'], ['>创建子程序的正当理由', '1.降低和隔离复杂度', '2.避免代码重复', '3.隐藏细节和顺序  例如：数据依赖', '4.提高可移植性', '5.简化复杂的判断'], ['>子程序内聚性设计', '1.顺序上的内聚性（计算依赖）', '2.过程上的内聚性（程序操作和用户操作同步）', '3.逻辑上的内聚性（大块if）'], ['>好的子程序名字', '1.描述子程序名字', '2.避免使用无意义的、模糊或表述不清的动词', '3.不要仅通过数字来形成不同的子程序名字', '4.对返回值有所描述', '5.为常用操作确立命名规则', '  startLittleGame() & playSmallGame()'], ['>子程序参数', '1.输入 > 修改 > 输出', '2.使用所有的参数', '3.把状态或出错变量放在最后', '4.不要把子程序的参数用作工作变量赋值', '5.注释对参数的假定说明', '6.合理参数上限 < 7', '7.输入 修改 输出 的命名规则'], ['>结束语', '1.创建子程序最主要的目的？', '  提高程序的可管理性、可靠性、可读性、可修改性', '2.应该让大多数子程序具有功能上的内聚性', '3.子程序的名字是它的质量的指示器'], ['Canvas', '一个画图标签、容器', '必须使用脚本来绘制图形', 'imgData:../../dist/image/1.png', 'Canvas 内到底有没有DOM结构？', 'Canvas 支持3D吗？', '原生不支持！', '必须自己使用代码运算！', 'canvas 环境绘制对象', 'canvas.getContext("2d")'], ['CanvasRenderingContext2D 线条绘制', 'context.beginPath() // 开始一个路径', 'context.moveTo(x, y) // 移动到坐标', 'context.lineTo(x, y) // 划线到坐标', 'context.fill() // 填充现有路径', '文字绘制', 'context.font = 12px 微软雅黑 // 字体&大小', 'context.strokeStyle = blue // 文字样式', 'context.strokeText(text, x, y) // 文字描边', 'context.fillText(text, x, y) // 文字填充'], ['区域绘制', 'context.clearRect(x, y, w, h) // 清除', 'context.rect(x, y, w, h) // 绘制矩形路径', 'context.arc(x, y, r, start, end) // 原型路径', 'context.fill() | context.stroke()', '图像的绘制', 'context.drawImage(HTMLImage, x, y, w, h) // 图像', 'context.drawImage(HTMLCanvas, x, y, w, h)', 'context.putImageData(imageData, x, y, w, h)', 'context.getImageData(x, y, w, h) // imageData'], ['context 修剪区域概念', 'context.beginPath(); // 开始路径', 'context.arc(x, y, r); // 绘制圆路径', 'context.rect(x, y, w, h) // 绘制矩形路径', 'context.bezierCurveTo(x,y,x,y,x,y) // 贝塞尔', 'context.clip() // 设置剪切区域', 'context.drawImage(img, x, y, w, h)', 'context.fillRect(x, y, x2, y2)', 'context.fillText(x, y, x2, y2) // 只影响剪切区域', 'context.restore() // 恢复']];
	module.exports = step;

/***/ },
/* 6 */
/*!********************************************!*\
  !*** ./public/dist/script/control-util.js ***!
  \********************************************/
/***/ function(module, exports, __webpack_require__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var require;var require;/* WEBPACK VAR INJECTION */(function(global) {"use strict";(function(f){if(true){module.exports = f();}else if(typeof define === "function" && define.amd){define([],f);}else {var g;if(typeof window !== "undefined"){g = window;}else if(typeof global !== "undefined"){g = global;}else if(typeof self !== "undefined"){g = self;}else {g = this;}g.io = f();}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require == "function" && require;if(!u && a)return require(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '" + o + "'");throw (f.code = "MODULE_NOT_FOUND",f);}var l=n[o] = {exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e);},l,l.exports,e,t,n,r);}return n[o].exports;}var i=typeof require == "function" && require;for(var o=0;o < r.length;o++) s(r[o]);return s;})({1:[function(_dereq_,module,exports){module.exports = _dereq_('./lib/');},{"./lib/":2}],2:[function(_dereq_,module,exports){module.exports = _dereq_('./socket'); /**
	 * Exports parser
	 *
	 * @api public
	 *
...
/***/ }
/******/ ]);
//# sourceMappingURL=cmd_bundle.js.map